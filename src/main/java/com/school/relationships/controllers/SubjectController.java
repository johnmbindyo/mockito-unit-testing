...
public class SubjectController {
    ...
    public ResponseEntity<?> createSubject(@RequestBody SubjectModel model) throws JsonProcessingException {
        Map<String, Object> responseMap = new HashMap<>();
        try {
            log.info("POST | Subject Creation Operation ={}", model);
            responseMap.put("Status", "Success");
            Integer subjectID = subjectService.createSubject(model);
